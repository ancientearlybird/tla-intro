...
"Weak Fairness" löst das "Stuttering".
(* Weak Fairness ist eine Form von Fairness, die besagt, dass, wenn ein Prozess unendlich oft bereit ist, dann wird er auch unendlich oft ausgeführt. *)


Es löst nicht das Problem, daß die Teilnehmer sich nicht entscheiden können.
